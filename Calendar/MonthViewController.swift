...
class MonthViewController: UIViewController{
    ...
    @IBOutlet weak var asd: UICollectionView!
    override func viewDidLoad() {
        super.viewDidLoad()
//        self.upMonthCollectionView.dataSource = self
//        self.upMonthCollectionView.register(UINib(nibName: "CollectionViewCell", bundle: nil), forCellWithReuseIdentifier : "MyCell")
    }
...
//        }
//        self.upMonthCollectionView.reloadData()
//   }
//
//}
